...
Sources: [RequestEnvelope](../../crates/focal-wire/src/message.rs#L171), [canonical.rs](../../crates/focal-model/src/canonical.rs#L97), and [frame.rs](../../crates/focal-wire/src/frame.rs#L34). Current `request FILE` is JSON-only and reads at most 1 MiB: [main.rs request arm](../../crates/focal-node/src/main.rs#L198). Current YAML support is deployment configuration, not evidence that wire-request YAML is already supported: [Settings::from_yaml](../../crates/focal-node/src/config/mod.rs#L88).
